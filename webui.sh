...
# If you can't download the model from the official website, you can use the mirror site.
# All you have to do is remove the comments in the following line.
...
# 0.0.0.0 It can only be stated as “hearing all web cards” and is not suitable for accessing the address as a browser.
# macOS/Linux Lower Browser Open http://0.0.0.0:8501 It's possible to go through a proxy or a gateway.
# Finally. 502。Default binding and opening 127.0.0.1，and Windows Start script consistent.
...
# Use Python Do port detection, avoid dependency. lsof/nc Different. macOS/Linux Differences in distribution.
