...
structured REFUSE message. The caller (scripts/trendpipe.py main()) writes
...
def _refuse_message(topic: str) -> str:
    return (
        f'[trendpipe] REFUSE: topic "{topic}" matches Class 1 keyword-trap '
        ...
        "re-invoke with TRENDPIPE_SKIP_PREFLIGHT=1 to bypass this gate.\n"
    )
