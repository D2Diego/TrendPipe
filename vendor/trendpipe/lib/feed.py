...
def render_atom(
    ...
    *,
    ...
    title: str = "trendpipe research library",
    author: str = "trendpipe research library",
) -> str:
    """Render an Atom feed whose IDs and timestamps are stable across runs."""
    urls = entry_urls or {}
    feed_id = f"urn:trendpipe:research-library:{library_id}"
    ...
    for item in entries:
        ...
        entry_id = item.entry_id.removeprefix("urn:trendpipe:")
