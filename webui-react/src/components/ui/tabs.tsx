...
export function Tabs({ tabs, initialTab }: { tabs: TabDef[]; initialTab?: string }) {
  const [active, setActive] = useState(() => tabs.some((tab) => tab.key === initialTab) ? initialTab : tabs[0]?.key);
  return <div>
