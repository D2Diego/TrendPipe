...
ENDPOINT_OVERRIDE_KEYS = {
    "BSKY_SEARCH_HOST",
    "TRENDPIPE_SEARXNG_URL",
    "TRENDPIPE_YOUTUBE_SSH_HOST",
    "OPENAI_BASE_URL",
    "XAI_BASE_URL",
...
def build(
    ...
    *,
    ...
    if ignored_project_config:
        action_items.append("Project config was ignored; set TRENDPIPE_TRUST_PROJECT_CONFIG=1 to trust it.")
...
def render_text(preflight: dict[str, Any]) -> str:
    ...
    lines: list[str] = ["trendpipe preflight"]
