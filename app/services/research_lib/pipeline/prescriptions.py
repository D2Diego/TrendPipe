...
ENGINE_CLI = "python3 skills/trendpipe/scripts/trendpipe.py"
...
REGISTRY: Dict[Tuple[str, str], Prescription] = dict((
    ...
    _entry(
        ...
        fix_nl=(
            ...
            "add BSKY_HANDLE plus BSKY_APP_PASSWORD to ~/.config/trendpipe/.env"
        ),
    ...
    _entry(
        ...
        fix_nl=(
            ...
            "~/.config/trendpipe/.env so caption-free videos still get "
    ...
    _entry(
        ...
        fix_nl=(
            ...
            "tools into ~/.config/trendpipe/.env"
        ),
        fix_cli=SETUP_BROWSER_COOKIES_CLI,
        anchor="api-keys-env",
    ),
    _entry(
        ...
        cause=(
            ...
            "in; trendpipe auto-probes http://localhost:18060 and "
