...
INDEX_FINGERPRINT_VERSION = "trendpipe-library-index/v2"
LIBRARY_CONTEXT_START = "<!-- trendpipe:library-context:start -->"
LIBRARY_CONTEXT_END = "<!-- trendpipe:library-context:end -->"
