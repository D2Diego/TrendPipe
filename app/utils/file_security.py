...
def resolve_path_within_directory(
    ...
    *,
    ...
    # User paths may be names, relative or absolute paths, or contain ``../``.
    # Resolve and compare real common paths so symlinks, duplicate separators,
    # and traversal cannot escape an allowlisted directory.
    if not unsafe_path:
    ...
    try:
        ...
        # commonpath raises ValueError for different Windows drives; such paths
