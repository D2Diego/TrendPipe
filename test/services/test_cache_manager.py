...
class TestVideoCacheManager(unittest.TestCase):
    """Validation cache management only handles controlled documents and performs light counting and clean-up by metadata."""
    ...
    def test_stats_only_include_managed_top_level_regular_files(self):
        """
        Unknown files, embedded files and symbolic links may belong to the user and cannot be entered into a volume count or clean-up candidate.
        """
        now = 2_000_000_000.0
        ...
        try:
            ...
            # Windows Creating a symbol link when the developer mode is not opened may not be authorized, without prejudice to the remaining assertions.
            pass
