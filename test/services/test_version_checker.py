...
class TestVersionChecker(unittest.TestCase):
    """Verify Version Comparison and GitHub Checking anomalies does not affect the main process."""
...
class TestAsyncUpdateChecker(unittest.TestCase):
    """Verifying back-office checks does not block callers and can reuse cache results."""
...
class TestProjectVersionMetadata(unittest.TestCase):
    """Prevents running-time version versus Python Project metadata are inconsistent."""
